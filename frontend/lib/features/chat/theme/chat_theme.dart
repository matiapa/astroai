  ...
  static LlmChatViewStyle get deepSpaceStyle => LlmChatViewStyle(
    ...
    userMessageStyle: UserMessageStyle(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.cyanAccent.withValues(alpha: 0.25)),
      ),
    ),
    llmMessageStyle: LlmMessageStyle(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0xFF3E3E5C)),
      ),
    ),
    chatInputStyle: ChatInputStyle(
      textStyle: GoogleFonts.inter(color: AppColors.textPrimary, fontSize: 15),
    ...
    recordButtonStyle: const ActionButtonStyle(iconColor: AppColors.cyanAccent),
    stopButtonStyle: const ActionButtonStyle(iconColor: AppColors.error),
    copyButtonStyle: const ActionButtonStyle(iconColor: AppColors.textMuted),
    editButtonStyle: const ActionButtonStyle(iconColor: AppColors.textMuted),
    closeButtonStyle: const ActionButtonStyle(iconColor: AppColors.textMuted),
    cancelButtonStyle: const ActionButtonStyle(iconColor: AppColors.textMuted),
    suggestionStyle: SuggestionStyle(
      textStyle: GoogleFonts.inter(color: AppColors.cyanAccent, fontSize: 14),
      decoration: BoxDecoration(
        color: AppColors.surface,
